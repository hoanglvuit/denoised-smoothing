...
plot_certified_accuracy_per_sigma_best_model(
    "/kaggle/working/certification_output/sigma012", 'With vs Without Denoiser', 1.5,
    methods=
...
plot_certified_accuracy_per_sigma_best_model(
    "/kaggle/working/certification_output/sigma025", 'With vs Without Denoiser', 1.5,
    methods=
...
plot_certified_accuracy_per_sigma_best_model(
    "/kaggle/working/certification_output/sigma05", 'With vs Without Denoiser', 1.5,
    methods=
...
plot_certified_accuracy_per_sigma_best_model(
    "/kaggle/working/certification_output/sigma100", 'With vs Without Denoiser', 1.5,
    methods=
